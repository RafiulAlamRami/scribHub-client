    ...
    return (
        <div>
            <div className='mb-[4em]'> 
                <h1 className='text-[2rem] font-bold my-[2em] text-center'><span className='border-b-2 shadow-md'>Add Blog</span></h1>
                    ...
                    <form onSubmit={HandleAddBlog}>
                        ...
                        <div className='flex gap-10 justify-center my-7'>
                            ...
                            <div className='flex flex-col gap-2  w-full'>
                                ...
                                <input type="text" placeholder="Long Description" name='longDes' className="input input-bordered w-full " />
                            </div>
