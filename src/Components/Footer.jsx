        ...
        <div>
            <footer className="footer footer-center p-10 bg-primary text-primary-content flex justify-around items-center foot">
                <aside>
                    ...
                    <p className='mt-[1em]'><span className='text-fira text-[1.3rem] font-semibold'>Your Knowledge Partner</span></p>
                ...
                <div>
                    <h1 className='text-[3rem] font-bold text-lex'>ScribHub</h1>
			...
			<div className="space-y-4">
				...
				<p className="flex items-center">
					...
					<span className='text-[1.3rem]'>contact@scribhub.com</span>
				</p>
			</div>
		</div>
